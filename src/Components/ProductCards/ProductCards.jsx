...
const ProductCards = () => {
  ...
  return (
    <section className="px-6 relative sm:px-6 md:px-6 lg:px-20 xl:px-20">
      <h1 className="text-3xl mt-5 sm:mt-5 md:mt-10 lg:mt-10 xl:mt-10 font-bold text-gray-800 text-center">
        All Products
      </h1>
      <div className="grid relative xl:pt-10 lg:pt-10 md:pt-10 sm:pt-5 pt-5 pb-16 grid-cols-2 place-items-center sm:grid-cols-3 md:grid-cols-3 xl:grid-cols-4 gap-8">
        {currentProducts.map((product) => (
          <div key={product.id} className="group xl:w-full lg:w-full md:w-full sm:w-full w-40 bg-white xl:rounded-xl lg:rounded-xl md:rounded-xl rounded shadow-sm hover:shadow-md border border-gray-100 overflow-hidden transition-all duration-300 ease-in-out flex flex-col hover:-translate-y-1">
            <div
                ...
                <div className="items-center text-sm text-gray-500 xl:mb-4 hidden xl:flex lg:flex md:flex sm:hidden">
                  <span
                    className={`w-2 h-2 rounded-full mr-2 ${
                      product.rating?.count > 0 ? "bg-green-500" : "bg-red-500"
                    }`}
                  ></span>
